...
│       │    ├─ activity_20110577449.gpx
│       │    └─ activity_16613729286.gpx
│       ├─ gpx_output/                       # CSV generated by NiFi
│       │    ├─ activity_20110577449.csv
│       │    └─ activity_16613729286.csv
│       ├─ nifi_data/                        # Persists NiFi flow configuration and logs
│       │    └─ journals/                    # Automatically generated during the execution
│       │           └─ checkpoint              
│       ├─ Analyse_CSV.ipynb                 # Notebook to show visualisation
│
├─ Flow_NIFI_execute.png                     # Screenshot (NiFi Execution) 
